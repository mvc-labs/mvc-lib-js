...
describe('ECIES', function () {
  ...
  it('use ephemeral privateKey if privateKey is not set', function () {
    ...
    (ephemeralKey instanceof mvc.PrivateKey).should.equal(true)
  })
  ...
  it('decrypting uncompressed keys', function () {
    ...
    // test uncompressed
    var alicePrivateKey = mvc.PrivateKey.fromObject({
      bn: '1fa76f9c799ca3a51e2c7c901d3ba8e24f6d870beccf8df56faf30120b38f360',
      compressed: false,
      network: 'livenet'
    })
    var alicePublicKey = mvc.PublicKey.fromPrivateKey(alicePrivateKey) // alicePrivateKey.publicKey
