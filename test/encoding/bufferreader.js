...
var BufferReader = mvc.encoding.BufferReader
...
describe('BufferReader', function () {
  ...
  describe('#readUInt64LEBN', function () {
    ...
    it('should return 10 mvc', function () {
      var tenmvc = 10 * 1e8
      var tenmvcBuffer = Buffer.from('00ca9a3b00000000', 'hex')
      var br = new BufferReader(tenmvcBuffer)
      br.readUInt64LEBN().toNumber().should.equal(tenmvc)
    })
