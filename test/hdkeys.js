...
var mvc = require('..')
var Networks = mvc.Networks
var HDPrivateKey = mvc.HDPrivateKey
var HDPublicKey = mvc.HDPublicKey
...
describe('BIP32 compliance', function () {
  ...
  describe('edge cases', function () {
    ...
    it('will handle edge case that derived private key is invalid', function () {
      ...
      var unstubbed = mvc.crypto.BN.prototype.toBuffer
      var count = 0
      sandbox.stub(mvc.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(mvc.PrivateKey, 'isValid')
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      mvc.PrivateKey.isValid.callCount.should.equal(2)
    })
    it('will handle edge case that a derive public key is invalid', function () {
      ...
      var unstubbed = mvc.PublicKey.fromPoint
      mvc.PublicKey.fromPoint = function () {
        mvc.PublicKey.fromPoint = unstubbed
