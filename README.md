...
Documentation is available on the [Money Button Documentation Page](https://docs.moneybutton.com/docs/mvc-overview.html).
...
**v0.27.0**
* Remove version guard. This should fix the "two versions of mvc" error that
  people often get. Note that it is poor practice to use incompatible versions
  of mvc. To send objects from one version of the library to another, always
...
**v0.26.5**
* lodash optimization and overall size optimization of mvc.min.js
* fix isFinal
